function FamilyEditController($location, $routeParams, familyStorage, orderStorage) {
  var family = this;
...
FamilyEditController.$inject = ['$location', '$routeParams', 'familyStorage', 'orderStorage'];

function FamilyNewController($location, familyStorage, orderStorage) {
  var family = this;
  var familyDb = familyStorage.load();
  var orderDb = orderStorage.load();
...
FamilyNewController.$inject = ['$location', 'familyStorage', 'orderStorage'];
